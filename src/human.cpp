...
namespace
{
    const char *HUMAN_IMG = "../Assets/Image files/human.png";
    const char *MUTE_OFF = "../Assets/Image files/mute.png";
    const char *MUTE_ON = "../Assets/Image files/unmute.png";
    const char *FONT_PATH = "../Assets/Fonts/Cinzel-Bold.ttf";
    const char *BG_IMG = "../Assets/Image files/background.png";
...
void callall()
{
    cardback = LoadTexture("../Assets/Image files/HomeUI.png");
